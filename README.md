...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Visit%20Now-blue?style=for-the-badge&logo=vercel)](https://ashrafi-frontdeveloper.github.io/Coffee-Shop/)
...
(Pro tip: Take your own screenshots of the live demo in both modes and upload them to the repo as `screenshot-light.png` and `screenshot-dark.png` — then update the links like this: `![Light Mode](screenshot-light.png)`)
